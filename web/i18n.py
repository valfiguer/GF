"""
GoalFeed i18n — lightweight bilingual ES/EN translation system.
No babel/gettext needed; just Python dicts + a simple t() helper.
"""
...
def get_lang(request) -> str:
    ...
    lang = request.cookies.get("gf_lang", "es")
    return lang if lang in ("es", "en") else "es"


def get_js_translations(lang: str) -> dict:
    """Return the subset of translations needed by JS."""
    prefix = "js."
    return {
        k[len(prefix):]: t(k, lang)

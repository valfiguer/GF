<?php $pageTitle = t('auth.login_title', $lang); ?>
<div class="gf-container gf-auth">
    <div class="gf-auth__card">
        <h1 class="gf-auth__title"><?= e(t('auth.login_title', $lang)) ?></h1>
        ...
        <form method="post" action="/auth/login">
            ...
            <div class="gf-auth__field">
                ...
                <input class="gf-auth__input" type="password" id="password" name="password" required autocomplete="current-password">
            </div>
            <button type="submit" class="gf-auth__submit"><?= e(t('auth.login_btn', $lang)) ?></button>
        </form>
        ...
        <div class="gf-auth__footer">
            <?= e(t('auth.no_account', $lang)) ?>
            <a href="/auth/register"><?= e(t('auth.register_btn', $lang)) ?></a>
        </div>
    </div>
</div>
